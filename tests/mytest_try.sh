...
time python3 kmeans_try.py 3 600 < tests/input_1.txt > my_output1py.txt
diff -s my_output1py.txt tests/output_1.txt
echo python test1 ended
echo python test2 started
time python3 kmeans_try.py 7 < tests/input_2.txt > my_output2py.txt
diff -s my_output2py.txt tests/output_2.txt
echo python test2 ended
echo python test3 started
time python3 kmeans_try.py 15 300 < tests/input_3.txt > my_output3py.txt
